...
export const MetricDistributionChart: React.FC<MetricDistributionChartProps> = ({ users, metric, chartType }) => {
  ...
  const getIncomeDistribution = () => {
    ...
    return Object.entries(incomeGroups).map(([name, value]) => ({ name, value }));
  };
  ...
  const COLORS = ['#3B82F6', '#EC4899', '#8B5CF6', '#10B981', '#F59E0B', '#EF4444', '#6B7280', '#8B5CF6', '#EC4899', '#3B82F6'];
